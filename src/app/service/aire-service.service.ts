...
export class AireService {
  ...
  private url = `${environment.apiUrl}/aireVentana`;

  constructor(private http: HttpClient) {}

  newAire(aire: any) : Observable<any> {
    return this.http.post(this.url, aire);
  }
  ...
  deleteAire(id: any): Observable<string> {
    console.log(`${environment.apiUrl}/aireVentana/delete/${id}`);
